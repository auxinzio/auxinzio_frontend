...
export default function JobDetailsPage() {
  ...
  const job = jobData[slug || ''] || jobData['senior-frontend-engineer'];
            ...
            >
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">{job.team}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    <DollarSign className="w-5 h-5 mt-0.5" style={{ color: '#14b8a6' }} />
                    <div>
              ...
              <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="space-y-3">
                  {[
                    { icon: DollarSign, text: 'Competitive salary & equity', color: '#22c55e' },
                    { icon: Home, text: 'Remote-first culture', color: '#06b6d4' },
                    { icon: GraduationCap, text: 'Learning budget', color: '#14b8a6' },
                    { icon: Users, text: 'Amazing team culture', color: '#22c55e' },
                  ].map((benefit, index) => {
              ...
              <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="space-y-3">
                  {relatedJobs.map((relatedJob) => (
                    ...
                    >
                      <p className="font-semibold text-gray-900 hover:text-[#22c55e] transition-colors">
                        {relatedJob.title}
                      </p>
                      <p className="text-sm text-gray-500">{relatedJob.team}</p>
                    </Link>
                  ))}
                </div>
              </div>
