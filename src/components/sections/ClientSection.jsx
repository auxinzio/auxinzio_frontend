                        ...
                        <div className="lg:col-span-5">
                          ...
                          >
                            <div className="flex items-center gap-4 mb-8">
                              ...
                              <span className="text-[10px] font-bold tracking-[0.5em] uppercase text-[#14b88f]">Global Synergy</span>
                            </div>
                            <h2 className="text-5xl lg:text-[7rem] font-light text-gray-900 tracking-tighter leading-[0.8] mb-12">
                              Our <br />
                              <span className="italic font-normal text-[#14b88f]">Elite</span> <br />
                              Network.
                            </h2>
