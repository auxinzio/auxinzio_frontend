                ...
                >
                  ...
                  <div className="mt-12 space-y-6 px-4">
                    ...
                    <button className="flex items-center gap-6 group/btn">
                       <span className="text-sm font-bold uppercase tracking-[0.3em] text-gray-900 group-hover:text-[#14b8a6] transition-colors underline underline-offset-8 decoration-gray-100 group-hover:decoration-[#14b8a6]">Inquire Architecture</span>
