                    ...
                    <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 relative">
                            ...
                            <div className="relative pt-24 lg:pt-32">
                                ...
                                <div className="space-y-6 text-gray-700 leading-relaxed max-w-xl">
                                    <p className="text-lg lg:text-xl">
                                        Our mission is to deliver reliable, high-quality IT solutions that drive business growth, elevate user experiences, and support digital transformation through advanced technologies, expert talent, and a strong commitment to excellence.
                                    </p>
                        ...
                        >
                            ...
                            <div className="relative pt-32 lg:pt-40">
                                ...
                                <div className="space-y-6 text-gray-700 leading-relaxed max-w-xl">
                                    <p className="text-lg lg:text-xl">
                                        To be a globally trusted technology partner, enabling organizations to achieve sustainable growth through innovative, secure, and scalable digital solutions.
                                    </p>
                                    {/* <p className="text-base lg:text-lg text-gray-600">
